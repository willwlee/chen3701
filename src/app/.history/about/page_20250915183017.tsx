      ...
      <section className="scroll-mt-28 mt-16 rounded-xl bg-zinc-50 dark:bg-zinc-800/25 p-8 shadow-sm">
        <div className="lg:order-first lg:row-span-2">
          <div className="aspect-video w-full">
            <iframe
              src="https://docs.google.com/presentation/d/e/2PACX-1vRYOnjq_GoEia2XC_dvWp6hgf108e1YnDhbxZ7c2xIIBR7XnB7zfbbVjIKwQizuW0SKoOM4WNiTPfKh/embed?start=false&loop=true&delayms=3000" 
              width="960" 
              height="569" 
              allowFullScreen
              className="border-0"
