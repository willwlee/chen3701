      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-300">
            <p>
              We are investigating the effectiveness of Amberlyte resin in water softening, specifically in removing <InlineMath math="Ca^{2+}"/> ions from DI & tap water.
              The fundamental theory is based on ion exchange, where 
              
              <InlineMath math="Ca^{2+}"/> ions are exchanged for <InlineMath math="H+"/> ions.
