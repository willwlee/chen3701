...
import portraitImage1 from '@/images/portrait.jpg'
import portraitImage2 from '@/images/portrait.jpg'
import portraitImage3 from '@/images/portrait.jpg'
    ...
    <Container className="mt-16 sm:mt-32">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            CH EN 3701: Project Website (Mon-8)
          </h1>
      ...
      <section id="members" className="scroll-mt-28 mt-16 rounded-xl bg-zinc-50 dark:bg-zinc-800/25 p-8 shadow-sm">
        <div className="flex items-center space-x-3">
          <h2 className="text-2xl font-bold text-zinc-800 dark:text-zinc-100 text-center">Team</h2>
        </div>
