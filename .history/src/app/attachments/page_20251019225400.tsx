...
const cardList = [
  {
    ...
    link: { href: 'https://github.com/willwlee/chen3701', label: 'Go to Repository', hover: 'Visit Repository' },
    logo: logoGithub,
  },
]
    ...
    >
      <div className="space-y-20">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl p-4 ring-1 items-center ring-zinc-200">
