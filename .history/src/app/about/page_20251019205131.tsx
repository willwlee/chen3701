        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-300">
            ...
            <p>
              ...
              Furthermore, the usefulness of ion-exchange resins can be found in lanthanide extraction processes, where extraction of lanthanide ions from rare earth solutions is 
