      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-300">
            ...
            <p>
              Furthermore, the unique properties of ion-exchange resins serve useful in lanthanide extraction processes, where extraction of lanthanide ions from rare earth solutions is 
