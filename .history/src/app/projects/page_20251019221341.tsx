    ...
    description: (
      <div className="space-y-2">
        <p>
          ...
          consistent with the expected range of Salt Lake City water hardness indices. Post-treatment Ca²⁺ levels dropped to nearly 0 mg/L by a significant amount -- suggesting 
