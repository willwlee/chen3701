...
const projects: Project[] = [
  ...
  <li>
    Calibrate Ca²⁺ probe using calibrated standards of 100 mg/L Ca²⁺ and 1000
    mg/L Ca²⁺.
  </li>
  <li>
    Measure 100 mL of tap water in a beaker. Record Ca²⁺ concentration and pH
    using probe and pH test strips.
  </li>
  <li>
    Flush the tap water through the buret, allowing the water to completely
    exit before measuring Ca²⁺ and pH again.
  </li>
  <li>
    Repeat Steps 3–5 twice more with tap water (for 3 total trial runs).
  </li>
