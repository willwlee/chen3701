...
const projects: Project[] = [
  {
    ...
    description:
      <p>
        ...
        1) Pour EWS ion exchange resin product into a buret. Charge it by submerging resin in 3M HCl for ~20 minutes.
        2) Once sufficiently charged, drain out HCl and dispose in a hazardous waste container. Rinse with DI water 1-2 times.
        3) Calibrate Ca2+ probe using calibrated standards of 100 mg/L Ca2+ and 1000 mg/L Ca2+
        4) Measure 100 mL of tap water in a beaker. Record Ca2+ concentration and pH using probe and pH test strips.
        5) Flush the tap water through the buret, allowing the water to completely exit before measuring Ca2+ and pH again.
        5) Repeat Steps 3-5 twice more with tap water (for 3 total trial runs).
        6) Repeat the experiment 3 times with DI water.
      </p>,
    logo: logoTheory,
    tags: ['Theory'],
  },  
