    ...
    description: (
      <div className="space-y-2">
        <p>
          ...
          consistent with the expected range of Salt Lake City water hardness measurements. Post-treatment Ca²⁺ levels dropped to nearly 0 mg/L by a significant amount -- suggesting 
          ion removal by EWS resin (Fig. 1).
        </p>
