    ...
    description:
      <div>
        ...
        <p>
          ...
          Furthermore, the resin decreased pH by an average change of -3.83 (± 0.29).<br /><br />
        </p>
        <p>
    ...
    description:
      <div>
        <p>
          ...
          Furthermore, since the Ca²⁺ concentration of DI are exactly 0.0 mg/L, we can conclude the Ca²⁺-selective electrode
          is calibrated correctly and functioning properly. Similar can be said for the pH probe, since the pH of DI water is
          very similar to the expected value of 7.0.
        </p>
      </div>,
    logo: logoResults,
    tags: ['Analysis'],
