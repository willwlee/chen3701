    ...
    description: (
      <div className="space-y-2">
        <p>
          ...
          the limit of detection (LOD) of the ion-selective electrode. Regardless, the significant change in concentration suggests effective Ca²⁺ removal by the EWS resin.
        </p>
